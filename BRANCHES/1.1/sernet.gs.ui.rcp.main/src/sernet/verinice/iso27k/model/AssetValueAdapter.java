...
public class AssetValueAdapter implements ISchutzbedarfProvider, Serializable {
    ...
    public int getIntegritaet() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("get Integrity for " + cnaTreeElement);
        }
    ...
    public int getVerfuegbarkeit() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("get avail. for " + cnaTreeElement);
        }
    ...
    public int getVertraulichkeit() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("get confid. for " + cnaTreeElement);
        }
    ...
    public void setIntegritaet(int i) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("set integrity for " + cnaTreeElement);
        }
    ...
    public void setVerfuegbarkeit(int i) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("set avail. for " + cnaTreeElement);
        }
        EntityType entityType = HUITypeFactory.getInstance().getEntityType(cnaTreeElement.getEntity().getEntityType());
    ...
    public void setVertraulichkeit(int i) {
        if (LOG.isDebugEnabled()) {
            LOG.debug("set confd. for " + cnaTreeElement);
        }
        EntityType entityType = HUITypeFactory.getInstance().getEntityType(cnaTreeElement.getEntity().getEntityType());
    ...
    private void fireVerfuegbarkeitChanged(CascadingTransaction ta) {
        ...
        try {
            ...
            Logger.getLogger(this.getClass()).debug("Verfügbarkeitsänderung abgebrochen.");
        } catch (RuntimeException e) {
            LOG.error("Error determining asset value", e);
            ta.abort();
        }
    }
    ...
    private void fireVertraulichkeitChanged(CascadingTransaction ta) {
        ...
        try {
            ...
            Logger.getLogger(this.getClass()).debug("Vertraulichkeitsänderung abgebrochen.");
        } catch (RuntimeException e) {
            LOG.error("Error determining asset value", e);
            ta.abort();
        }
    ...
    private void fireIntegritaetChanged(CascadingTransaction ta) {
        ...
        try {
            ...
            Logger.getLogger(this.getClass()).debug("Integritätsänderung abgebrochen.");
        } catch (RuntimeException e) {
            LOG.error("Error determining asset value", e);
            ta.abort();
        }
